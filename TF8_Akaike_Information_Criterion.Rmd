...
ALL_models=dredge(Huracan_Dep) # Evaluación de todas las compbinaciones/alternativas (modelos)
...
# Calculate the lower and upper bound of the coeffcients
...
ggplot(BMR, mapping=aes(x=Variables, y = Coef_Estimate,
  ...
  geom_pointrange()+
  xlab("Variables")+
  ylab("Mean Coefficients: Alien Species")+
  rlt_theme+
  theme(legend.position="none")

ggsave("Alien Species Coefficients.png")
