...
Cuando se utiliza regresión múltiples basado usando el método de mínimos cuadrados (**OLS**, ordinary least square), se asume que que cumple con los siguientes supuestos.  
