...
library(gridExtra) # Un paquete para organizar las figuras de ggplot
...
Con la opción **stackdir** uno puede ubicar los puntos de forma diferente; por ejemplo, centrados al eje de Y como se muestra en la siguiente figura.  Para especificar la dirección en que se quieren ubicar los datos, se indica que los puntos comienzan al centro con el parámetro **center**; si comienzan arriba, con **down**; si abajo, con **up**; y si al centro con los puntos alineados, con **centerwhole** (centralizados, pero con los daos aliñados).
