...
```
 ...
 + Hacer gráfico de la variable de respuesta. ¿Cual de la lista es la variable de respuesta y porque?
...
SI HAY Sobre dispersión CUAL ALTERNATIVA TIENE PARA EVALUAR EL MODELO?
Contruir el modelo
...
Evaluar el porcentaje del income que se usa para comida.   Cumple con las condiciones de una beta?  Si no como se resuelve?
