...
Select different values of x, and calculate the mean and variance, and then convert these in $\alpha$ and $\beta$.  With these construct the beta distribution. 
