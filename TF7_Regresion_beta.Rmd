...
Articulo sobre regresión beta y diferentes paquetes de R que se puede usar para hacer los análisis [Douma and Weedon 2019](https://besjournals.onlinelibrary.wiley.com/doi/10.1111/2041-210X.13234)
...
```
 ...
 Nota:
 - hay valores de proporciones negativa
 - el intervalo de confianza también es negativo
 - la dispersión de los datos en y alrededor de la media no es igual a medida que el gasto de salud per capita cambia (en x).  
...
Los datos provienen de World Bank en el siguiente enlace, [Smokers](https://data.worldbank.org/indicator/SH.PRV.SMOK).  En el archivo se encuentra información sobre 187 pais y la proporción de población mayor de 15 años que fuman. 
...
Smokers %>% select(Country_Name, Y2000P)
```
...
Aquí un script para convertir los parametros en shape
...
```{r, out.width="150",   fig.cap ="from this webpage: https://binalongbungalows.wordpress.com/tasmanian-orchids/dipodium-roseum-rosy-hyacinth-orchid-0615-web/",echo=FALSE, out.extra='style="float:right; padding:10px"', fig}
