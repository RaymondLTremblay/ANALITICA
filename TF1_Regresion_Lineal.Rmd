...
FROM WIKIPEDIA
Definition. Data points with large residuals (outliers) and/or high leverage may distort the outcome and accuracy of a regression. Cook's distance measures the effect of deleting a given observation. Points with a large Cook's distance are considered to merit closer examination in the analysis.
...
D_i>4/n, where n is the number of observations, might be used.

Aqui enseño como añadir 
1. los valores de "cook.distance" a su archivo
2. Añadir una columna de "secuencia" de los datos
3. Crear una gráfica de las distancia de Cook.  
...
3. Evaluar si los datos cumple con los supuestos.
  ...
  1. Igualdad de varianza, usa la gráfica de residuales
  2. Normalidad, qqplot
  3. Valores sesgados, la prueba de Cook's
